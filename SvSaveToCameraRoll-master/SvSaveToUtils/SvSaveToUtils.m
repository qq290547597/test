...
//    [videoArray addObjectsFromArray:movs];
    ...
    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"mp4" inDirectory:nil];
    [videoArray addObjectsFromArray:movs];
    
    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"MP4" inDirectory:nil];
    [videoArray addObjectsFromArray:movs];
    
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"asf" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"avi" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"flv" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"mpg" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"wmv" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
//    movs = [[NSBundle mainBundle] pathsForResourcesOfType:@"3gp" inDirectory:nil];
//    [videoArray addObjectsFromArray:movs];
